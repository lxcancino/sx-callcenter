export const labels = {
  ...
  resetPasswordTabText:
    'Restablecer la dirección de correo electrónico a la contraseña',
  resetPasswordInputText:
    'Restablecer la dirección de correo electrónico a la contraseña',
  resetPasswordErrorRequiredText:
    'Se requiere un correo electrónico para restablecer la contraseña!',
  resetPasswordErrorPatternText:
    'Por favor, introduce una dirección de correo electrónico válida',
  resetPasswordActionButtonText: 'Reiniciar',
  resetPasswordInstructionsText:
    'Restablecimiento solicitado. Revise sus instrucciones de correo electrónico.',
