...
@Component({
  selector: 'swrx-autorizados-table',
  templateUrl: './autorizados-table.component.html',
  styleUrls: ['./autorizados-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AutorizadosTableComponent implements OnInit {
    ...
    return [
      ...
      },
      {
        ...
        valueGetter: params => {
          ...
          if (d.autorizacion) {
            return d.autorizacion.fecha;
          } else {
            return null;
          }
        },
        valueFormatter: params => this.transformDate(params.value, 'short')
      },
      {
        headerName: 'Autorizo',
        field: 'autorizo',
